...
namespace Realm.GPA.GCS.DAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="gaports")]
    ...
    partial void InsertRealm_GPA_GCS_Carrier_Image(Realm_GPA_GCS_Carrier_Image instance);
    partial void UpdateRealm_GPA_GCS_Carrier_Image(Realm_GPA_GCS_Carrier_Image instance);
    partial void DeleteRealm_GPA_GCS_Carrier_Image(Realm_GPA_GCS_Carrier_Image instance);
    ...
    partial void DeleteRealm_GPA_GCS_Port(Realm_GPA_GCS_Port instance);
		...
		public System.Data.Linq.Table<Realm_GPA_GCS_Carrier_Image> Realm_GPA_GCS_Carrier_Images
		{
			get
			{
				return this.GetTable<Realm_GPA_GCS_Carrier_Image>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.[Realm.GPA.GCS.Carrier_Images]")]
	public partial class Realm_GPA_GCS_Carrier_Image : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void Onimage_urlChanged();
		...
		public Realm_GPA_GCS_Carrier_Image()
		{
			this._Realm_GPA_GCS_Carrier = default(EntityRef<Realm_GPA_GCS_Carrier>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Realm_GPA_GCS_Carrier_Realm_GPA_GCS_Carrier_Image", Storage="_Realm_GPA_GCS_Carrier", ThisKey="carrier_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Realm_GPA_GCS_Carrier Realm_GPA_GCS_Carrier
		{
			get
			{
			...
			set
			{
							...
							|| (this._Realm_GPA_GCS_Carrier.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Realm_GPA_GCS_Carrier.Entity = null;
						previousValue.Realm_GPA_GCS_Carrier_Images.Remove(this);
					}
					this._Realm_GPA_GCS_Carrier.Entity = value;
					if ((value != null))
					{
						value.Realm_GPA_GCS_Carrier_Images.Add(this);
						this._carrier_id = value.id;
					}
					else
					{
	...
	public partial class Realm_GPA_GCS_Carrier : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Realm_GPA_GCS_Carrier_Image> _Realm_GPA_GCS_Carrier_Images;
    ...
    partial void Onwebsite_urlChanged();
		...
		{
			this._Realm_GPA_GCS_Services_Carriers = new EntitySet<Realm_GPA_GCS_Services_Carrier>(new Action<Realm_GPA_GCS_Services_Carrier>(this.attach_Realm_GPA_GCS_Services_Carriers), new Action<Realm_GPA_GCS_Services_Carrier>(this.detach_Realm_GPA_GCS_Services_Carriers));
			this._Realm_GPA_GCS_Carrier_Images = new EntitySet<Realm_GPA_GCS_Carrier_Image>(new Action<Realm_GPA_GCS_Carrier_Image>(this.attach_Realm_GPA_GCS_Carrier_Images), new Action<Realm_GPA_GCS_Carrier_Image>(this.detach_Realm_GPA_GCS_Carrier_Images));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Realm_GPA_GCS_Carrier_Realm_GPA_GCS_Carrier_Image", Storage="_Realm_GPA_GCS_Carrier_Images", ThisKey="id", OtherKey="carrier_id")]
		public EntitySet<Realm_GPA_GCS_Carrier_Image> Realm_GPA_GCS_Carrier_Images
		{
			get
			{
				return this._Realm_GPA_GCS_Carrier_Images;
			}
			set
			{
				this._Realm_GPA_GCS_Carrier_Images.Assign(value);
			}
		}
		...
		private void attach_Realm_GPA_GCS_Carrier_Images(Realm_GPA_GCS_Carrier_Image entity)
		{
			this.SendPropertyChanging();
			entity.Realm_GPA_GCS_Carrier = this;
		}
		
		private void detach_Realm_GPA_GCS_Carrier_Images(Realm_GPA_GCS_Carrier_Image entity)
		{
			this.SendPropertyChanging();
			entity.Realm_GPA_GCS_Carrier = null;
		}
